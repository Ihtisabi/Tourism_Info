    ...
    Card(
        ...
        Row(
            ...
            Column(
                ...
                Row {
                    Text(
                        text = stringResource(sport.locationId),
                        style = MaterialTheme.typography.bodySmall
                    )
                    Spacer(Modifier.weight(1f))
                    if (sport.free) {
                        Text(
                            text = stringResource(R.string.free_caption),
...
@Composable
private fun SportsListImageItem(sport: Place, modifier: Modifier = Modifier) {
    Box(
        modifier = modifier
    ) {
        Image(
            ...
            Box {
                ...
                Column(
                    ...
                    Row(
                        ...
                        Text(
                            text = stringResource(selectedSport.locationId),
                            style = MaterialTheme.typography.bodySmall
                        )
                        Spacer(Modifier.weight(1f))
                        if (selectedSport.free) {
                            Text(
                                text = stringResource(R.string.free_caption),
                                style = MaterialTheme.typography.labelMedium
                            )
